...
public class Messages {
    ...
    public static void getMessages() {
        ...
        noChestplateEquipped = config
                .getString("no-chestplate-equipped", "&2You do not have a &fchestplate &2equipped");
        ...
        bannedInRegion = config.getString("item-banned-in-region",
                "&2This item is banned in this region and cannot be traded.");
