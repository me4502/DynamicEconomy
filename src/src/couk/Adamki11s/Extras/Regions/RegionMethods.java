...
public abstract class RegionMethods {
     ...
     * @param point2
     *            Point 2.
     * @return A boolean value indicating whether the player is within the
     *         specified region or not.
     */
     ...
     * @param point2
     *            Point 2.
     * @return Returns an integer containing the number of blocks(Including air
     *         blocks) within the specified region.
     */
