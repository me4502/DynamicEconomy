...
public class AUCore {
    ...
    public AUCore(String website, Logger l, String pref) {
        ...
        try {
            ...
            ex.printStackTrace();
            log.info("[AU]" + prefix
                    + " Malformed URL Exception. Make sure the URL is in the form 'http://www.website.domain'");
        }
    ...
    public boolean checkVersion(double currentVersion, double currentSubVersion, String pluginname) {
        ...
        if (versionNO != currentVersion) {
            ...
            log.info("[AU]" + prefix + " Running version : " + currentVersion + "_" + subVers + ". Latest version : "
                    + versionNO + "_" + subVersionNO + ".");
            log.info("[AU]" + prefix + " Update urgency for version " + versionNO + "_" + subVersionNO + " : "
                    + urgency + ".");
            ...
            log.info("[AU]" + prefix + " Update reason : " + reason);
            return false;
        } else if (versionNO == currentVersion && subVersionNO == currentSubVersion) // log.info("[AU]"
                                                                                     // +
                                                                                     // prefix
                                                                                     // +
    ...
    public void forceDownload(String downloadLink, String pluginName, Player player) {
        ...
        log.info("[AU]" + prefix + " Newest version of " + pluginName + " has been downloaded to : '/plugins/"
                + pluginName + ".jar");
