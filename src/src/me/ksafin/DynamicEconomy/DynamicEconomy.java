...
public class DynamicEconomy extends JavaPlugin {
    ...
    public static boolean                      restrictWorlds;

    public AUCore                              updater         = new AUCore("http://exampop.com/update.html", log,
            "[DynamicEconomy]");
    ...
    public void onEnable() {
        ...
        if (DynamicEconomy.enableOverTimePriceDecay || DynamicEconomy.enableOverTimePriceInflation) {
            ...
            .scheduleSyncRepeatingTask(this, new Transaction(itemConfig, itemsFile), 300L, delay);
    ...
    public static void relConfig() {
        ...
        restrictWorlds = config.getBoolean("restrict-world", true);
