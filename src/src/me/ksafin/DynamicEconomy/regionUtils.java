...
public class regionUtils {
    ...
    public static boolean withinRegion(int x, int y, int z) {
        ...
        for (int i = 0; i < sections.length; i++) {
            ...
            if (x > regionXMin && x < regionXMax && y > regionYMin && y < regionYMax && z > regionZMin
                    && z < regionZMax) return true;
    ...
    public static boolean expandRegion(Player player, String[] args) {
        ...
        if (args.length != 2 && args.length != 1) {
            color.sendColouredMessage(player, DynamicEconomy.prefix
                    + "&2Wrong Command Usage. &f/expandreg [north|south|east|west|up|down|vert] (amount)");
        ...
        if (args.length != 0) {
            ...
            if (DynamicEconomy.groupControl) {
                color.sendColouredMessage(player,
                        "&2Allowed Purchase Groups: &f" + Utility.listToString(purchaseGroups));
    ...
    public static void removeItemGroup(Player player, String[] args) {
        if (args.length != 3) {
            color.sendColouredMessage(player, DynamicEconomy.prefix
                    + "&2Wrong Command Usage. &f/removeregiongroup [Region] [Sale|Purchase] [ItemGroupName]");
            ...
            if (regionFileConfig.contains(node) == false) {
                color.sendColouredMessage(player, DynamicEconomy.prefix + "&2Region &f" + args[0]
                        + "&2 does not exist.");
            ...
            if (DynamicEconomy.groupsConfig.contains(args[2]) == false && args[2].equals("*") == false) {
                color.sendColouredMessage(player, DynamicEconomy.prefix + "&2Item Group &f" + args[2]
                        + "&2 does not exist.");
            ...
            if (args[1].equalsIgnoreCase("purchase")) {
                ...
                color.sendColouredMessage(player, DynamicEconomy.prefix + "&f" + args[1]
                        + "&2 is not a valid type. Use either 'Sale' or 'Purchase'");
            ...
            color.sendColouredMessage(player, DynamicEconomy.prefix + "&2Item Group &f" + args[2]
                    + " &2 removed from region &f" + args[0]);
    ...
    public static void addItemGroup(Player player, String[] args) {
        if (args.length != 3) {
            color.sendColouredMessage(player, DynamicEconomy.prefix
                    + "&2Wrong Command Usage. &f/addregiongroup [Region] [Sale|Purchase] [ItemGroupName]");
            ...
            if (groups.contains(args[2])) {
                color.sendColouredMessage(player, DynamicEconomy.prefix + "&2Item Group &f" + args[2]
                        + "&2 is already allowed for " + args[1]);
                return;
            }
    ...
    public static void banRegionItem(Player player, String[] args) {
        ...
        if (args.length != 3) {
            color.sendColouredMessage(player, DynamicEconomy.prefix
                    + "&2Wrong Command Usage. &f/banitem [Region] [sale|purchase] [Item]");
            ...
            if (item.equals("")) {
                ...
                if (bannedString.contains(item)) {
                    color.sendColouredMessage(player, DynamicEconomy.prefix + "&f" + item
                            + "&2 is already banned in this region.");
                    Utility.writeToLog(player.getName() + " tried to ban " + item + " in region " + args[0]
                ...
                color.sendColouredMessage(player, DynamicEconomy.prefix + "&f" + item + "&2 banned from &f" + args[1]
                        + "&2 in region &f" + args[0] + "&2 succesfully.");
    ...
    public static void unbanRegionItem(Player player, String[] args) {
        ...
        if (args.length != 3) {
            color.sendColouredMessage(player, DynamicEconomy.prefix
                    + "&2Wrong Command Usage. &f/unbanitem [Region] [sale|purchase] [Item]");
            ...
            if (item.equals("")) {
                ...
                if (regionFileConfig.contains(node) == false) {
                    color.sendColouredMessage(player, DynamicEconomy.prefix + "&2Region &f" + args[0]
                            + "&2 does not exist.");
                    Utility.writeToLog(player.getName() + " called /unbanregionitem with non-existant region "
                            + args[0]);
                    return;
                }
                ...
                if (bannedString.contains(item) == false) {
                    color.sendColouredMessage(player, DynamicEconomy.prefix + "&f" + item
                            + "&2 isn't banned in this region as it is.");
                    Utility.writeToLog(player.getName() + " tried to unban " + item + " in region " + args[0]
                            + " but it isn't banned.");
                    return;
                }
                ...
                color.sendColouredMessage(player, DynamicEconomy.prefix + "&f" + item + "&2 unbanned from &f" + args[1]
                        + "&2 in region &f" + args[0] + "&2 succesfully.");
                Utility.writeToLog(player.getName() + " unbanned " + item + " from " + args[1] + " in region "
                        + args[0]);
            }
    ...
    public static boolean deleteShopRegion(Player player, String[] args) {
        ...
        if (args.length != 1) {
            color.sendColouredMessage(player, DynamicEconomy.prefix
                    + "&2Wrong Command Usage. &f/removeshopregion [name]");
