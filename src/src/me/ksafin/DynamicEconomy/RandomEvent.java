            ...
            if (type.equalsIgnoreCase("price")) {
                ...
                for (Player p : Bukkit.getServer().getOnlinePlayers()) {
                    if (!Utility.isQuiet(p)) {
                        ...
                        color.sendColouredMessage(p, DynamicEconomy.prefix + "&2New Price of &f" + item + "&2 is &f"
                                + DynamicEconomy.currencySymbol + strPrice + "&2 (" + strChange + ")");
                    }
                }
                ...
                for (Player p : Bukkit.getServer().getOnlinePlayers()) {
                    if (!Utility.isQuiet(p)) {
                        color.sendColouredMessage(p, DynamicEconomy.prefix + description);
                        color.sendColouredMessage(p, DynamicEconomy.prefix + "&2New Stock of &f" + item + "&2 is &f"
                                + newStock + "&2 (" + strChange + ")");
                    }
                }
