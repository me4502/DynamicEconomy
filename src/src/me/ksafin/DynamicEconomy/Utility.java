...
public class Utility {
    ...
    public void checkLog() {
        ...
        /*
         * if (log.exists() == false) { try {
         * //logger.info(log.getAbsolutePath()); //log.createNewFile();
         * FileOutputStream fos = new FileOutputStream(log); fos.flush();
    ...
    public static void wrongArgsMessage(Player player) {
        color.sendColouredMessage(player,
                "&2You have put entered &finvalid &2 arguments for this command. &fTry Again.");
    }
