...
public class dataSigns {
    ...
    public dataSigns(final SignChangeEvent event) {
        ...
        if (lines[0].equalsIgnoreCase("dynamicsign")) {
            ...
            if (item.equalsIgnoreCase("purchasetax") || item.equalsIgnoreCase("salestax")) {
                ...
                curSign.set("TYPE", item); // Set TYPE to either purchasetax or
                                           // salestax
    ...
    public static void checkForUpdatesNonRegular(String item, double changeVelocity, double changeCeiling,
            double changeFloor) {
        FileConfiguration conf = DynamicEconomy.signsConfig;
    ...
    public static void updateItem(String item, String signID, double changeVelocity, double changeCeiling,
            double changeFloor) {
        FileConfiguration conf = DynamicEconomy.signsConfig;
