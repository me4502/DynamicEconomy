...
public abstract class InventoryMethods {
     ...
     * 
     * @param p
     *            The player's inventory to add the item to.
     * @param m
     *            The Material to add.
     * @param quantity
     *            The quantity to add.
     ...
     * 
     * @param p
     *            The player's inventory to remove from.
     * @param m
     ...
     * 
     * @param p
     *            The player's inventory to search.
     * @param m
     *            The material to check.
     * @return A boolean value indicating whether the player's inventory
    ...
    /**
     * Get the amount of itemstack's with the specified item in the players
     * inventory.
     * 
     * @param p
     *            The player's inventory to search.
    ...
    /**
     * Get the number of blocks of the specified item within the player's
     * inventory.
     * 
     * @param p
     *            The player's inventory to search.
    ...
    /**
     * Organises the players inventory. Groups blocks together into stacks and
     * reformats.
     * 
     * @param p
     *            The player's inventory to format.
     */
    ...
    /**
     * Wipe the players inventory clean. This will delete their entire
     * inventory.
     * 
     * @param p
     *            The player's inventory to wipe.
     */
    public abstract void wipeInventory(Player p);

    /**
     * Store the contents of the player's inventory. (Saved in RAM, Volatile).
     * Data will not be retained after a server restart/crash/shutdown.
     * 
     * @param p
     *            The player's inventory to save.
     * @return
     */
    public abstract boolean storeInventory(Player p);

    /**
     * Retrieve the contents of the player's inventory from an earlier
     * 'storeInventory'.
     * 
     * @param p
     *            The player's saved inventory to retrieve.
     * @return An ItemStack[] array containing the contents of the saved
     *         inventory.
     */
