...
public abstract class PlayerMethods {
     ...
     * @param p
     *            The player to check.
     * @return A boolean value indicating whether the player is on the ground or
     *         not.
     */
     ...
     * @param p
     *            The player to check.
     * @return A boolean value indicating whether the player is underwater or
     *         not.
     */
     ...
     * 
     * @param p
     *            The player who will mount the entity.
     * @param e
     *            The entity which the player will mount.
     */
     ...
     * 
     * @param mounter
     *            The player who will mount the target player.
     * @param playerToMount
     *            The player who will be mounted.
     */
     ...
     *            The player to set.
     * @param m
     *            The material to set the player's head to.
     */
     ...
     *            The player to set.
     * @param id
     *            The item id to set the player's head to.
     */
